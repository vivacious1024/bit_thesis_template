...
export default {
  ...
  setup() {
    ...
    const assetLibraryDirectory = ref('')
    const assetLibraryDirectoryDraft = ref('')
    const assetLibraryDirectoryDefault = ref('')
    const assetLibraryDirectoryLoading = ref(false)
    const assetLibraryDirectorySaving = ref(false)
    const assetLibraryCanPickDirectory = ref(false)
